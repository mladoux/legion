...
var parseNames = function (config, channel, nicks) {
    ...
    Object.keys(nicks).forEach(nick => {
        ...
        // This section doesn't work, commenting out until I find a bertter
        ...
        switch(perm) {
            case '+':
                setVoice(channel, nick, true);
            break;
            case '%':
                setHop(channel, nick, true);
            break;
            case '@':
                setOp(channel, nick, true);
            break;
            case '&':
                setSop(channel, nick, true);
            break;
            case '~':
                setOwner(channel, nick, true);
            break;
        }
        */
